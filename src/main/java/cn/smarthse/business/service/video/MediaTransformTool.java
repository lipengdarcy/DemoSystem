 ...
 * 利用ffmpeg 进行视频转码
 */
public class MediaTransformTool {
	...
	public void processFLV(String ffmpegPath, String upFilePath, String codcFilePath) {
		 ...
		 * 
		 * convert.add("-ab"); // 设置音频码率 convert.add("64");
		 * 
		 * convert.add("-ac"); // 设置声道数 convert.add("2");
		 * 
		 * convert.add("-ar"); // 设置声音的采样频率 convert.add("22050");
		 * 
		 * convert.add("-r"); // 设置帧频 convert.add("24");
		 * 
