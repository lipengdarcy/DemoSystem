...
package cn.smarthse.framework.algs.v1;

import java.util.Arrays;

import cn.smarthse.framework.algs.v0.In;
import cn.smarthse.framework.algs.v0.StdIn;
import cn.smarthse.framework.algs.v0.StdOut;
...
public class BinarySearch {
	...
	public static void main(String[] args) {
		...
		// read the integers from a file
		 In in = new In(args[0]);
		//String param = "algs4-data/tinyT.txt";
		//In in = new In(param);
